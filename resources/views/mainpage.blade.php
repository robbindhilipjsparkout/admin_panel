    ...
    <nav class="navbar navbar-expand-custom navbar-mainbg">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('login') }}" style="background-color: white; color: blue; border: 1px solid blue; border-radius: 5px; font-size: 15px;padding:7px;margin-right:10px;"><i class="far fa-address-book"></i>Sign-In</a>
                </li>
                <li class="nav-item">
